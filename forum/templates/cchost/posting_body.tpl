<!-- BEGIN switch_cc_ping -->
<script language="JavaScript" type="text/javascript">
cc_ping_cchost("{CC_BASE_URL}/forum/topicposted/{CC_TOPIC_URL}");
</script>
<!-- END switch_cc_ping -->
...
<script>
function cc_calc_subject_type(txt)
{
  if( txt.length > 0 )
  {
		document.write("<input type=\"hidden\" name=\"subject\" value=\"" + txt + "\" />" );
		document.write("<b>" + txt + "</b>" );
  }
  else
  {
		document.write("<input type=\"text\" name=\"subject\" size=\"45\" maxlength=\"60\" style=\"width:450px\" tabindex=\"2\" class=\"post\" value=\"" + txt + "\" />" );
  }
}
</script>

        <!-- BEGIN switch_cc_review --> 
<h1 id="page_title">{CC_TITLE}</h1>
        <!-- END switch_cc_review --> 
        <!-- BEGIN switch_no_cc_review --> 
<h1 id="page_title">{L_POST_A}</h1>
        <!-- END switch_no_cc_review --> 
...
<!-- BEGIN switch_cc_review --> 
<form action="{CC_POST_ACTION}" method="post" name="post" onsubmit="return checkForm(this)">
<!-- END switch_cc_review --> 
<!-- BEGIN switch_no_cc_review --> 
...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
    ...
    <script>cc_calc_subject_type("{CC_REVIEW_SUBJECT}{SUBJECT}");</script>
		</span> </td>
	</tr>
	<tr> 
	  <td class="row1" valign="top"> 
		<table width="100%" border="0" cellspacing="0" cellpadding="1">
		  ...
		  <tr> 
			<td valign="middle" align="center"><!-- BEGIN SQUACH_SMILEY --> <br />
