...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
  ...
  <!-- BEGIN reg_user_row -->
  <tr> 
	<td width="35%" class="{reg_user_row.ROW_CLASS}">&nbsp;<span class="gen"><script>cc_swap_olink('{reg_user_row.USERNAME}');</script></span>&nbsp;</td>
  ...
  <!-- END reg_user_row -->
  <tr> 
	<td colspan="3" height="1" class="row3"><img src="templates/cchost/images/spacer.gif" width="1" height="1" alt="."></td>
  </tr>
  <tr> 
