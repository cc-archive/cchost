...
CCEvents::AddHandler(CC_EVENT_MAP_URLS,    array( 'CCActivityLogAPI' ,   'OnMapUrls'),   'ccextras/cc-activity-log.inc');
CCEvents::AddHandler(CC_EVENT_ADMIN_MENU,  array( 'CCActivityLogAPI',    'OnAdminMenu'), 'ccextras/cc-activity-log.inc');
...
class CCActivityLogAPIHV
{
    ...
    */
    function Hook($args)
    {
        ...
        require_once('ccextras/cc-activity-log.inc');
