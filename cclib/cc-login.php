...
class CCNewUserForm extends CCUserForm
{
    ...
    */
    function CCNewUserForm()
    {
        ...
        $fields = array( 
                    'user_name' =>
                        array( 'label_str'  => 'str_login_name',
                               'formatter'  => 'newusername',
                               'form_tip_str' => 'str_this_must_consist',
                               'flags'      => CCFF_REQUIRED  ),
                    'user_email' =>
                       array( 'label_str'       => 'str_e_mail',
                               'formatter'  => 'email',
                               'form_tip_str' => 'str_this_address_will',
                               'flags'      => CCFF_REQUIRED ),
                );
        ...
        if( !$has_mail )
        {
            $fields += array(
                    'user_password' =>
                       array(  'label_str'     => 'str_password',
                               'formatter'     => 'password',
                               'form_tip_str'  => 'str_this_must_be',
                               'flags'         => CCFF_REQUIRED )
                );
        }
        ...
        if( $has_mail )
        {
            $fields += array(
                    '_lost_password' =>
                       array(  'label_str'      => 'str_lost_password',
        ...
        $this->SetSubmitText('str_register');
    }
    ...
    */
    function validator_newusername($fieldname)
    {
        if( $this->validator_must_exist($fieldname) )
        {
            ...
            {
                $this->SetFieldError($fieldname, array('str_this_must_letters') );
                return(false);
            }

            if( strlen($value) > 25 )
            {
                $this->SetFieldError($fieldname, array('str_this_must_be_less') );
                return(false);
            }
    ...
    */
    function CCUserLoginForm()
    {
        ...
        $fields = array( 
                    ...
                    'user_remember' =>
                       array(  'label_str'      => 'str_remember_me',
                               'formatter'  => 'checkbox',
                               'flags'      => CCFF_NONE ),

                    '_new_user' =>
                       array(  'label_str'       => 'str_new_user',
                               'formatter'  => 'statictext',
...
class CCLostPasswordForm extends CCUserForm
{
    ...
    */
    function CCLostPasswordForm()
    {
        ...
        $this->AddFormFields( $fields );
        $this->SetSubmitText('str_retrieve_password');
    }
}
