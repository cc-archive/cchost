...
function cc_install_licenses()
{
    $default_licenses= array( 
                array( 'license_id' => 'attribution',
                       ...
                       'license_strict' => 10,
                       'license_text' => '<strong>Attribution</strong>: People can copy, distribute, perform, display, transform and make money from your work for any purpose as long they give you credit (attribution).'
                       ),
                array( 'license_id' => 'noncommercial', 
                       ...
                       'license_enabled' => true,
                       'license_strict' => 20,
                       'license_text' => '<strong>Attribution Noncommercial</strong>: People can copy, distribute, perform, display and transform your work for any purpose as long they give you credit (attribution). People may <i>not</i> use your work for commercial purposes.'
                       ),
                ...
                array( 'license_id' => 'noderives'   , 
                       ...
                       'license_strict' => 30,
                       'license_text' => '<strong>Attribution NoDerivatives</strong>: People can copy, distribute, perform, and display your work "as is" (without changes) for any purpose (e.g. file sharing) as long they give you credit (attribution).'
                       ),
                ...
                array( 'license_id' => 'by-nc-nd'   , 
                       ...
                       'license_enabled' => false,
                       'license_strict' => 40,
                       'license_text' => '<strong>Attribution Noncommercial No Derivatives</strong>: People can copy, distribute, perform, display, your work "as is" (without modifcations) for <b>non commercial purposes only</b> as long they give you credit (attribution).'
                       ),
                array( 'license_id' => 'sampling'   , 
                       ...
                       'license_enabled' => false,
                       'license_strict' => 125,
                       'license_text' => '<strong>Sampling</strong>: People can take and transform <strong>pieces</strong> of your work for any purpose other than advertising, which is prohibited. Copying and distribution of the <strong>entire work</strong> is also prohibited.'
                       ),
                 array( 'license_id' => 'sampling+',
                        'license_url' => 'http://creativecommons.org/licenses/sampling+/1.0/',
