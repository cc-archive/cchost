...
if( !empty($A['detail']) ) { $A['idetail'] = $A['detail']; } else {  $A['idetail'] = null; } $A['by'] = _('by');
...
?><h3  class="dtitle"><a  href="<?= $A['R']['file_page_url']?>"><?= $A['upname']?></a> <?= $A['by']?> 
...
?><a  href="<?= $A['P']['file_page_url']?>" class="cc_file_link"><?= $A['upname']?></a> <?= $A['by']?>
