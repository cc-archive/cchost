...
<div class="trr">
  <div class="tdc cc_playlist_item" id="_pli_%(#R/upload_id)%">
    <span>
      <a class="cc_playlist_pagelink" id="_plk_%(#R/upload_id)%" target="_parent" href="%(#R/file_page_url)%">%chop(#R/upload_name,30)%</a>
     </span>%text(str_by)% <a target="_parent" href="%(#R/artist_page_url)%">%chop(#R/user_real_name,30)%</a>
  </div>
