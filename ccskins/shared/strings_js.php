...
var str_confirm_membership        ='<?=addslashes($T->String('str_collab_confirm_membership'))?>';
var str_credit                    ='<?=addslashes($T->String('str_collab_credit2'))?>';
...
var str_remove                    ='<?=addslashes($T->String('str_collab_remove2'))?>';
...
var str_send_email                ='<?=addslashes($T->String('str_collab_send_email'))?>';
