...
<?$A['total_uploads'] = cc_stats_total_uploads();$A['total_remixes'] = cc_stats_total_uploads('remix');$A['total_pells'] = cc_stats_total_uploads('acappella');$A['total_orgs'] = cc_stats_total_uploads('original');$A['total_samps'] = cc_stats_total_uploads('sample');$A['rtotal_pells'] = cc_stats_percent_remixed('acappella');$A['rtotal_orgs'] = cc_stats_percent_remixed('original');$A['rtotal_samps'] = cc_stats_percent_remixed('sample');?><table  class="statstable" style="float:left">
