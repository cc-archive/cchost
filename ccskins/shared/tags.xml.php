...
<?$carr104 = $A['all_tags'];$cc104= count( $carr104);$ck104= array_keys( $carr104);for( $ci104= 0; $ci104< $cc104; ++$ci104){    $A['t'] = $carr104[ $ck104[ $ci104 ] ];   ?><div  style="text-align:right">
...
<?$carr105 = $A['tag_array'];$cc105= count( $carr105);$ck105= array_keys( $carr105);for( $ci105= 0; $ci105< $cc105; ++$ci105){    $A['tag'] = $carr105[ $ck105[ $ci105 ] ];   ?><span  class="cc_tag_count">
<a  href="<?= $A['tag']['tagurl']?>" rel="nofollow tag" class="cc_tag_link" style="line-height:110%;font-size:<?= $A['tag']['fontsize']?>px"><?= $A['tag']['tags_tag']?></a> (<?= $A['tag']['tags_count']?>)</span><?if ( !($ci105 == ($cc105-1)) ) {?>, <?}}?><p  class="cc_tag_bottom">&nbsp;</p>
<?}?>