<h1 id="page_title">{FORUM_NAME}</h1>
<form method="post" action="{S_POST_DAYS_ACTION}">
  <table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
	...
	<!-- BEGIN CC_DONT_SHOW -->
      <span class="gensmall"><b>{L_MODERATOR}: {MODERATORS}<br /><br />{LOGGED_IN_USER_LIST}</b></span>
	<!-- END CC_DONT_SHOW -->
      </td>
	...
	<tr> 
	  <td align="left" valign="middle" width="50">
        <!-- BEGIN switch_user_logged_in -->
          <a href="{U_POST_NEW_TOPIC}" class="cc_gen_button"><span>{L_POST_NEW_TOPIC}</span></a>
  ...
  <table border="0" cellpadding="4" cellspacing="1" width="90%" class="forumline">
	...
	<tr> 
	  ...
	  <td class="row3" align="center" valign="middle"><span class="name"><script>cc_swap_link('{topicrow.TOPIC_AUTHOR}');</script></span></td>
	  <td class="row2" align="center" valign="middle"><span class="postdetails">{topicrow.VIEWS}</span></td>
	  <td class="row3Right" align="left" valign="middle" nowrap="nowrap"><span class="postdetails">{topicrow.LAST_POST_TIME}<br />
      <script>cc_swap_link('{topicrow.LAST_POST_AUTHOR}');</script>
                {topicrow.LAST_POST_IMG}</span></td>
	</tr>
	<!-- END topicrow -->
